...
-- Session restore fixup (filetype/treesitter/numbers) lives in
-- lua/rafi/plugins/editor.lua (persistence.nvim init). It must be registered
-- before VimEnter; this file loads lazily at VeryLazy, which is too late for
-- the autoloaded session.
